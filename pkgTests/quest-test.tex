...
\pgfkeys{/tikzquests,Yb/.get=\YYb}
  \draw 
  (0,2) \ncoord(Aa) 
  (0,0) \ncoord(Ab)to[R,l=\QuestVal{Yxb}] ++(10,0)
  %node[Quad,anchor=inner 1+,inner x fit to={Aa}{Ba},y fit to=(Aa)(Ab)](Qa){}
  (0,0) node[Quad Y,y fit to={Aa}{Ab},european,Y11=\YYb,Y22=\YYb,Y12=-\YYb,Y21=-\YYb](Qa){}
  ;
}
...
\ftikzQuestion[EletronicaI/bipolar]{E.I:BandWidth:02c}[Yxb=5]
